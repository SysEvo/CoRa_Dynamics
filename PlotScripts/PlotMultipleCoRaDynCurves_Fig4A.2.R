...
OutCoRaDynFile1 <- read.table("./OUT_ExSSs_Dyn_tspan_PID_Ex01_bC_bP0.4_bD0.15_tspan501-4000.txt", sep="\t", header=TRUE)
OutCoRaDynFile2 <- read.table("./OUT_ExSSs_Dyn_tspan_PID_P_Ex01_bC_bP0.4_bD0.15_tspan501-4000.txt", sep="\t", header=TRUE)
OutCoRaDynFile3 <- read.table("./OUT_ExSSs_Dyn_tspan_PID_D_Ex01_bC_bP0.4_bD0.15_tspan501-4000.txt", sep="\t", header=TRUE)
OutCoRaDynFile4 <- read.table("./OUT_ExSSs_Dyn_tspan_PID_PD_Ex01_bC_bP0.4_bD0.15_tspan501-4000.txt", sep="\t", header=TRUE)
...
# Save plot image 
#save_plot(paste("../Plots/Fig4A_xlim",paste(xlim, collapse = "-"),".svg", sep = ""), fig = plot, height = 7.7*3, width = 3*3)
